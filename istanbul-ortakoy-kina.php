...
<section class="page-banner-area pt-170 rpt-110 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/cp-gorseller/dugun/banner-2.jpg)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">Aşk, Tutku ve Detaylar</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center wow fadeInUp delay-0-4s">
                    <li class="breadcrumb-item"><a href="index.php">Anasayfa</a></li>
                    <li class="breadcrumb-item active">Kına</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5">
                <div class="about-page-content rmb-55 wow fadeInUp delay-0-2s">
                    <div class="section-title mb-35">
                        ...
                        <h2>En güzel anınıza coşku, aşk ve detaylarla dokunuyor, hayallerinizdeki kına gecesini gerçeğe dönüştürüyoruz.</h2>
                        <p>Göz alıcı balo salonumuz ve 500 metrekarelik banket teras alanımızda muhteşem kına törenleri, nişanlar, düğünler ve sosyal etkinlikler düzenleyebilirsiniz. Profesyonel ekipler tarafından yönetilen kına töreni hizmetlerimizle, özel gününüzü eksiksiz ve unutulmaz kılmak için yanınızdayız.</p>
                    </div>
            ...
            <div class="col-xl-6 col-lg-7">
                <div class="who-we-are-image rmb-55 wow fadeInUp delay-0-2s">
                    <img src="assets/images/kina.jpg" alt="Who We Are">
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonials-area py-130 rpy-100 rel z-1 bg-color-and-shapes ">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 wow fadeInLeft delay-0-2s">
                <div class="booking-search rmb-55 rel bg-white" style="border: solid 1px;">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-8 col-md-11">
                <div class="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                    <h2>Hayallerinizdeki kına törenini gerçeğe dönüştürmek için buradayız! Kına töreni gününüzde sizi ve sevdiklerinizi ağırlamaktan mutluluk duyacak, profesyonel ekibimizle her detayı özenle planlayacağız.</h2>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5">
                <div class="activity-left-content mb-40 rmb-55 wow fadeInUp delay-0-2s">
                    <div class="section-title mb-35">
                        ...
                        <p>Hayalinizdeki kına törenini gerçeğe dönüştürmek için buradayız! İster zarif ister sade bir tören hayal edin, sizin için unutulmaz bir deneyim sunmak için her detayı düşündük.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="row gap-50">
                    <div class="col-lg-4 col-6 col-small">
                        <div class="service-item style-two wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <h4><a href="#">Kına Töreni Menülerimiz</a></h4>
                                <p>Lezzetin doruklarına çıkacağınız menülerimizle nişanınızı unutulmaz kılın. Damak zevkinize uygun seçeneklerle, konuklarınıza unutulmaz bir ziyafet sunuyoruz.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-6 col-small">
                        <div class="service-item style-two wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                <h4><a href="#">Profesyonel Ekibimiz</a></h4>
                                <p>Kına töreni gününüzde yanınızda olan deneyimli ve samimi ekibimiz, her detayı kusursuzca yönetiyor. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-6 col-small">
                        <div class="service-item style-two wow fadeInUp delay-0-5s">
                            ...
                            <div class="content">
                                <h4><a href="#">Ortaköy'deki Konumumuz</a></h4>
                                <p>Tarihi dokusu ve modern olanaklarıyla dikkat çeken bu mekân, nişanınızı benzersiz kılacak bir atmosfer sunar.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center justify-content-between">
                ...
                <div class="testimonial-two-active rmb-55">
                    <div class="testimonial-item-two">
                        <div class="testi-speech">
                            Gerçek aşk, en güzel nişanlarda kusursuz bir dansa dönüşür; kına töreniniz ise bu dansın notalarını düzenler, romantizmi ölümsüz kılar”
                        </div>
            ...
            <div class="col-lg-6">
                <div class="testimonial-two-right rel wow fadeInRight delay-0-2s">
                    <img src="assets/images/kina-2.jpg" alt="Testimonials">
