...
<section class="page-banner-area pt-195 rpt-135 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/blog/istanbul-koprusu-1920.png)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">Şekerci Cafer Erol</h1>
        </div>
    </div>
    <div class="bg-lines">
        <span></span><span></span>
...
<section class="product-details mb-100 pt-100 rpt-70 rel z-1">
    ...
    padding: 50px;" src="assets/images/cafer-erol-logo.jpg" alt="Perview">
                        </div>
            ...
            <div class="col-lg-6">
                <div class="product-details-content mt-35 rmt-55 wow fadeInRight delay-0-2s">
                    ...
                    <div class="section-title">
                        <h2>Şekerci Cafer Erol</h2>
                    </div>
                    <p>Şekerci Cafer Erol, tatlı yolculuğuna 1807 yılında başladı. Geçmişin tatları ile gelecek zaman arasında köprü oluşturan Şekerci Cafer Erol, yaratıcılığı ve yeteneğini tutku ile birleştirerek vazgeçilmezliğini hep korumuştur.
                    </p>
