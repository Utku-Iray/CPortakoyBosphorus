...
<section class="page-banner-area pt-195 rpt-135 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/blog/istanbul-koprusu-1920.png)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">Fitness Salonu</h1>
        </div>
    </div>
    <div class="bg-lines">
        <span></span><span></span>
        ...
        <div class="row gap-90">
            ...
            <div class="col-lg-6">
                <div class="product-details-content mt-35 rmt-55 wow fadeInRight delay-0-2s">
                    ...
                    <p>Crowne Plaza Ortaköy’ün son teknoloji ekipmanlarla donatılan fitness salonu, sporundan asla vazgeçemeyenler için konforlu ve enerjik bir atmosfer sunuyor. Kardiyo, ağırlık, yoga gibi birçok antrenmanı en verimli şekilde geçirmenizi sağlayan fitness salonumuzla, spor deneyiminiz bir üst seviyeye taşınıyor.
