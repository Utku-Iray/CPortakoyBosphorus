...
<section class="page-banner-area pt-195 rpt-135 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/blog/istanbul-koprusu-1920.png)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">Sanitas Spa & Fitness</h1>
        </div>
    </div>
    <div class="bg-lines">
        <span></span><span></span>
        ...
        <div class="row gap-90">
                ...
                <div class="product-details-images wow fadeInLeft delay-0-2s">
                    <div class="tab-content preview-images">
                        <div class="tab-pane fade preview-item active show" id="preview1">
                            <img src="assets/images/sosyal-imkanlar/spa-fitness/spa.jpg" alt="Perview">
                        </div>
                        <div class="tab-pane fade preview-item" id="preview2">
                            <img src="assets/images/sosyal-imkanlar/spa-fitness/fitnes.jpg" alt="Perview">
                        </div>

                    </div>
                    <div class="nav thumb-images rmb-20">
                        <a href="#preview1" data-bs-toggle="tab" class="thumb-item active show">
                            <img src="assets/images/sosyal-imkanlar/spa-fitness/spa.jpg" alt="Thumb">
                        </a>
                        <a href="#preview2" data-bs-toggle="tab" class="thumb-item">
                            <img src="assets/images/sosyal-imkanlar/spa-fitness/fitnes.jpg" alt="Thumb">
                        </a>
            ...
            <div class="col-lg-6">
                <div class="product-details-content mt-35 rmt-55 wow fadeInRight delay-0-2s">
                    ...
                    <p>“Dokunuşun Farklılığı” ilkesiyle en üst düzeyde SPA ve Türk hamamı hizmeti veren Sanitas SPA, tüm dünya masajları, Uzakdoğu bakımları, Hint Ayurveda ritüelleri, cilt, vücut bakımları ve fizyoterapi uygulamalarıyla günün yorgunluğunu atmanız ve yenilenmeniz için sizleri bekliyor.
                    </p>
