...
<section class="page-banner-area pt-195 rpt-135 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/blog/istanbul-koprusu-1920.png)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">King Standart Bridge</h1>
        </div>
    </div>
    <div class="bg-lines">
        <span></span><span></span>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="room-details-content rmb-55">
                    ...
                    <p>Otelimizin standart odaları, şıklığı ve rahatlığı bir araya getirerek konaklamanızı unutulmaz kılıyor. Ferah tasarımı ve düşük anahtar renk paletiyle döşenmiş odalarımız, konforlu yataklar, düzenli temizlik ve günlük ihtiyaçlarınızı karşılamak üzere düşünülmüş detaylarla sizleri ağırlıyor.
                        <br><br>
                        Her odada ücretsiz Wi-Fi, düz ekran TV, mini buzdolabı, kahve makinesi gibi modern olanaklarla donatılmıştır. Misafirlerimizin ihtiyaçlarına karşılık veren konseptimiz sayesinde, iş veya tatil amaçlı seyahat eden herkesin konforlu bir konaklama geçirmesini sağlıyoruz. Odalarımız, doğal ışık alan geniş pencerelerle aydınlatılmış olup, sakin bir atmosfer sunarak günün yorgunluğunu atmanızı sağlıyor.
                        <br><br>

                        Otelimizin standart odalarında, konforlu bir konaklamanın yanı sıra, konumumuzun sağladığı avantajlardan da faydalanabilirsiniz. Şehir merkezine yakın konumuyla iş seyahatlerinizde pratik bir tercih sunarken, çevresindeki turistik yerlere kolay erişim imkânı da sunmaktadır.
                    </p>
                    <div class="room-details-images mt-45 wow fadeInUp delay-0-2s">
                        <img src="assets/images/odalar/standart-oda/king-standart/std-king-2.jpg" alt="Room Details">
