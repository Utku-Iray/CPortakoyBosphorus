...
<section class="page-banner-area pt-195 rpt-135 pb-190 rpb-125 rel z-1 bgs-cover bgc-black text-center" style="background-image: url(assets/images/blog/istanbul-koprusu-1920.png)">
    <div class="container">
        <div class="banner-inner text-white rpb-25">
            <h1 class="page-title wow fadeInUp delay-0-2s">King Premium Bosphorus Bridge View With Sofa Bed</h1>
        </div>
    </div>
    <div class="bg-lines">
        <span></span><span></span>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="room-details-content rmb-55">
                    ...
                    <p>Otelimizin premium odaları, konuklarımıza özel bir konaklama deneyimi sunmak için tasarlanmıştır. Modern şıklığı, özenle seçilmiş detaylarla bir araya getirerek, size unutulmaz anlar yaşatacak bir atmosfer sunuyoruz. Premium odalarımız, geniş alanları, zarif mobilyaları ve özel tasarım detayları ile sizi karşılıyor.
                        <br>
                        <br>
                        Her detayın özenle düşünüldüğü premium odalarımızda, konforunuzu en üst seviyede tutmak için özel olarak seçilmiş yatak takımları, yumuşacık yastıklar ve lüks banyo olanakları bulunmaktadır. Ayrıca, odanızdan muhteşem manzaraların keyfini çıkarabileceğiniz geniş pencerelerle donatılmıştır.
                        <br>
                        <br>
                        Premium konaklama deneyiminin yanı sıra, oda içindeki özel detaylar da dikkatinizi çekecek. Size özel çalışma alanları, ücretsiz yüksek hızlı Wi-Fi, düz ekran TV, mini bar ve kahve makinesi gibi olanaklarla donatılmış odalarımız, iş seyahatlerinizi konforlu hale getirmek için idealdir.
                        <br>
                        <br>
                        Otelimizin premium odalarında kendinizi özel hissedecek, lüks ve konforun tadını çıkaracaksınız. Sizi ağırlamaktan mutluluk duyacağımız bu özel odalarda, unutulmaz bir konaklama geçirmenizi dileriz.
                    </p>
                    <div class="room-details-images mt-45 wow fadeInUp delay-0-2s">
                        <img src="assets/images/odalar/premium-oda/king-bridge-sofa-bed/king-pre-sofa-bed-2.jpg" alt="Room Details">
