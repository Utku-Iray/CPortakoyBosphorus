                    ...
                    <div class="col-lg-6">
                        <div class="about-content-part">
                            ...
                            <div class="about-author wow fadeInUp delay-0-4s">
                                <div class="author">
                                    <img src="assets/images/about/about-author.jpg" alt="Author">
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center pb-20">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a class="theme-btn mb-40 wow fadeInRight delay-0-2s" href="room-grid.html">Explore Rooms <i class="fal fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="hotel-carousel-active">
                    <div class="hotel-item wow fadeInUp delay-0-2s">
                        ...
                        <div class="image">
                            <img src="assets/images/hotel/hotel1.jpg" alt="Hotel">
                        </div>
                    </div>
                    <div class="hotel-item wow fadeInUp delay-0-4s">
                        ...
                        <div class="image">
                            <img src="assets/images/hotel/hotel2.jpg" alt="Hotel">
                        </div>
                    </div>
                    <div class="hotel-item wow fadeInUp delay-0-2s">
                        <div class="content">
                    ...
                    <div class="col-lg-7">
                        <div class="food-drink-image rel wow fadeInUp delay-0-4s">
                            ...
                            <div class="popular-clients">
                                ...
                                <img src="assets/images/food/popular-client1.jpg" alt="Client">
                                <img src="assets/images/food/popular-client2.jpg" alt="Client">
                                <img src="assets/images/food/popular-client3.jpg" alt="Client">
                                <img src="assets/images/food/popular-client4.jpg" alt="Client">
                                <img src="assets/images/food/popular-client5.jpg" alt="Client">
                            </div>
                        </div>
                    </div>
                </div>
