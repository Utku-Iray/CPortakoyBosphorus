        ...
        <div class="banner-inner text-white rpb-25">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center wow fadeInUp delay-0-4s">
                    ...
                    <li class="breadcrumb-item active">Nişan</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5">
                <div class="about-page-content rmb-55 wow fadeInUp delay-0-2s">
                    <div class="section-title mb-35">
                        ...
                        <h2>En güzel anınıza coşku, aşk ve detaylarla dokunuyor, hayallerinizdeki nişanı gerçeğe dönüştürüyoruz.</h2>
                        <p>Göz alıcı balo salonumuz ve 500 metrekarelik banket teras alanımızda muhteşem nişanlar, düğünler ve sosyal etkinlikler düzenleyebilirsiniz. Profesyonel ekipler tarafından yönetilen nişan hizmetlerimizle, özel gününüzü eksiksiz ve unutulmaz kılmak için yanınızdayız.</p>
                    </div>
            ...
            <div class="col-xl-6 col-lg-7">
                <div class="who-we-are-image rmb-55 wow fadeInUp delay-0-2s">
                    <img src="assets/images/nisan-2.jpg" alt="Who We Are">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-8 col-md-11">
                <div class="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                    <h2>Aşkınızı taçlandırmak, hayallerinizdeki nişanı gerçeğe dönüştürmek için buradayız! Nişan gününüzde sizi ve sevdiklerinizi ağırlamaktan mutluluk duyacak, profesyonel ekibimizle her detayı özenle planlayacağız.</h2>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5">
                <div class="activity-left-content mb-40 rmb-55 wow fadeInUp delay-0-2s">
                    <div class="section-title mb-35">
                        ...
                        <p>Hayalinizdeki nişanı gerçeğe dönüştürmek için buradayız! İster zarif bir nişan, ister sade bir tören hayal edin, sizin için unutulmaz bir deneyim sunmak için her detayı düşündük.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <div class="row gap-50">
                    <div class="col-lg-4 col-6 col-small">
                        <div class="service-item style-two wow fadeInUp delay-0-3s">
                            ...
                            <div class="content">
                                <h4><a href="#">Nişan Menülerimiz</a></h4>
                    ...
                    <div class="col-lg-4 col-6 col-small">
                        <div class="service-item style-two wow fadeInUp delay-0-4s">
                            ...
                            <div class="content">
                                ...
                                <p>Nişan gününüzde yanınızda olan deneyimli ve samimi ekibimiz, her detayı kusursuzca yönetiyor</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-6 col-small">
        ...
        <div class="row align-items-center justify-content-between">
                ...
                <div class="testimonial-two-active rmb-55">
                    <div class="testimonial-item-two">
                        <div class="testi-speech">
                            Gerçek aşk, en güzel nişanlarda kusursuz bir dansa dönüşür; nişan organizasyonu ise bu dansın notalarını düzenler, romantizmi ölümsüz kılar
                        </div>
            ...
            <div class="col-lg-6">
                <div class="testimonial-two-right rel wow fadeInRight delay-0-2s">
                    <img src="assets/images/nisan-1.jpg" alt="Testimonials">
